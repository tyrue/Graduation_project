...
namespace Ardunity
{
    ...
    [AddComponentMenu("ARDUnity/Reactor/Transform/RotationReactorB")]
    [HelpURL("https://sites.google.com/site/ardunitydoc/references/reactor/rotationreactor")]
    public class RotationReactorB : ArdunityReactor
    {
        ...
        void Update()
        {
            ...
            Debug.Log("1번"+"x:" + _curRotation.x + " / " + "y:" + _curRotation.y + " / " + "z:" + _curRotation.z + " / " + "w:" + _curRotation.w);
            ...
            Debug.Log("1번초기값" + "x:" + a.x + " / " + "y:" + a.y + " / " + "z:" + a.z + " / " + "w:" + a.w);
            //print(a);
