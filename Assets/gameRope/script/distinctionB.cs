...
namespace Ardunity
{
	...
	public class distinctionB : ArdunityReactor
    {
        ...
        void Update()
        {
            ...
            RotationReactorB _curRotation1 = GameObject.Find("movingPerson").GetComponent<RotationReactorB>(); // 1번
            RotationReactor2B _curRotation2 = GameObject.Find("movingPerson").GetComponent<RotationReactor2B>(); // 2번
            RotationReactor3B _curRotation3 = GameObject.Find("movingPerson").GetComponent<RotationReactor3B>(); // 3번
            RotationReactor4B _curRotation4 = GameObject.Find("movingPerson").GetComponent<RotationReactor4B>(); // 4번
...

            {
                ...
                {
                    // 초기화 영상 재생
                    GameObject obj = Instantiate(Resources.Load("InitializingWaist")) as GameObject;
                    initial = true;
                }
          ...
          //  }
           ...
           // print("2번" + snow1);
            ...
            if (( 0.1f < Math.Abs(abc6.x) && Math.Abs(abc6.x) < 0.4f)
                   &&( 0.25f < Math.Abs(abc6.y) &&  Math.Abs(abc6.y) < 0.6f))
                {
                    ...
                    else if((abc6.x + abc6.y + abc6.z > -0.9f) && (abc6.x + abc6.y + abc6.z < 0.9f))                                                        // 오른쪽조건 :  -0.9 < x+y+z < 0.9
                    {
                        rightback = true;
