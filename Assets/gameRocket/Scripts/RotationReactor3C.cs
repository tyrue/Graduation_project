...
namespace Ardunity
{
    ...
    [AddComponentMenu("ARDUnity/Reactor/Transform/RotationReactor3C")]
    [HelpURL("https://sites.google.com/site/ardunitydoc/references/reactor/rotationreactor")]
    public class RotationReactor3C : ArdunityReactor
    {
        ...
        void Update()
        {
            ...
            Debug.Log("3번"+"x:" + _curRotation.x + " / " + "y:" + _curRotation.y + " / " + "z:" + _curRotation.z + " / " + "w:" + _curRotation.w);
            ...
            Debug.Log("3번초기값" + "x:" + a.x + " / " + "y:" + a.y + " / " + "z:" + a.z + " / " + "w:" + a.w);
            //print(a);
